  ...
  return (
    <div className="space-y-5">
      <AdminPageHeader
        ...
        subtitle="Monitor outstanding balances across customers."
        onRefresh={refetch}
        actionLabel="Refresh"
      />
          ...
          <TableBody>
            {credits.length === 0 ? (
              ...
              <TableRow key={c.customerId} className="hover:bg-slate-50/60">
                ...
                <TableCell className="text-right font-semibold text-amber-700">Rs {Number(c.pendingCredit ?? 0).toLocaleString()}</TableCell>
              </TableRow>
            ))}
          </TableBody>
        </Table>
...
export default AdminCreditTracking
